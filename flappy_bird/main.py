...
ground_img = pygame.image.load(os.path.join("flappy_bird/img/ground.png"))
button_img = pygame.image.load(os.path.join("flappy_bird/img/restart.png"))
...
def reset_game():
    ...
    # sets score as local variable
    score = 0
    # resets the score back to zero, globally
    return score
...
class Bird(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        # creates rectangle boundary around image
